...
string ofxFilterbank::midiToNote(int midi){
    ...
    switch (mod){
        case 0: noteName = " "; //C
            ofSetColor(77,163,137,8);//most green
            break;
        case 1: noteName = " "; //C#
            ofSetColor(75,149,143,8);
            break;
        case 2: noteName = " "; //D
            ofSetColor(72,135,149,8);
            break;
        case 3: noteName = " "; //D#
            ofSetColor(70,121,155,8);
            break;
        case 4: noteName = " ";
            ofSetColor(68,107,161,8);
            break;
        case 5: noteName = " ";
            ofSetColor(65,93,167,8);
            break;
        case 6: noteName = " ";
            ofSetColor(60,77,176,8);//most blue
            break;
        case 7: noteName = " ";
            ofSetColor(64,96,174,8);
            break;
        case 8: noteName = " ";
            ofSetColor(68,115,171,8);
            break;
        case 9: noteName = " ";
            ofSetColor(72,134,169,8);
            break;
        case 10: noteName = " ";
            ofSetColor(76,143,166,8);
            break;
        case 11: noteName = " ";
            ofSetColor(77,162,163,8);
            break;
        default:
            break;
